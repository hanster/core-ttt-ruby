...
module TicTacToe
  describe Board do
    ...
    it "retrieves all possible moves for a 3x3 board" do
      board = Board.make_board(3)
      expect(board.all_moves).to eq((0...9).to_a)
    end

    it "retrieves all possible moves for a 4x4 board" do
      board = Board.make_board(4)
      expect(board.all_moves).to eq((0...16).to_a)
    end
  end
end
